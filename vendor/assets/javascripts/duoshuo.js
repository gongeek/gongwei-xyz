var duoshuoQuery = {short_name: "gongweixyz"};
!function (e, t, s) {
    function a() {
    ...
    if (o.extend = function (e, t) {
        ...
        var A = {
            ...
            newhua: "706ba4eb",
            justflat: "9d72ec5a"
        }, U = {"embed.compat": "24f8ca3f", smilies: "921e8eda"}, D = {
            post: "发布",
            posting: "正在发布",
            settings: "设置",
            reply: "回复",
            ...
            if (t.visitor && (!nt.data && t.visitor.user_id && e.Notification && M.send({logged_user_id: t.visitor.user_id}), nt.reset(t.visitor)), t.site && (rt.reset(t.site), z.save("ds_site_" + c.short_name, t.site)), !S.theme && rt.data.theme && n(rt.data.theme), t.lang && (o.extend(D, t.lang), z.save("ds_lang_" + c.short_name, t.lang)), t.stylesheets)for (var s = 0; s < t.stylesheets.length; s++)o.injectStylesheet(t.stylesheets[s]);
        ...
        et.commentList = function (e) {
            ...
            var t = '<h2>转发到微博</h2><div class="ds-quote"><strong>@' + u(e.post.theAuthor.name) + "</strong>: " + e.post.message + "</div><form>" + tt({post_id: e.post.post_id}) + '<div class="ds-textarea-wrapper"><textarea name="message" title="Ctrl+Enter快捷提交" placeholder="' + u(D.repost_reason) + '">' + u(e.repostMessage) + '</textarea><pre class="ds-hidden-text"></pre>';
            ...
            var t = '<div class="ds-header ds-gradient-bg">' + u(D.hot_posts_title) + "</div><ul>", s = e.list;
        ...
        var st = S.Views = {}, at = (S.Callbacks = {}, S.pagelets = []), it = S.events = new J, rt = S.site = new V, nt = S.visitor = new $, ot = S.unread = new V, dt = S.threadPool = new G(Y), lt = S.postPool = new G(F), ct = S.userPool = new G($);
        it.on("queryDefined", function () {
            ...
            function x(e, t, s, a) {
                function i() {
                    function e(e) {
                        if (s && a) {
                            var t = s.options, i = A(s.postList.el, e.response[a], t);
                ...
                render: function (e) {
                    ...
                    var q = function (e) {
                        s(b), R.post("posts/create", H.extend(S.toJSON(b), e), function (e) {
                            var t = lt[e.response.post_id] = new F(e.response), s = A(i.postList, t, c);
            ...
            X.mouseenter(N).mouseleave(I), st.PostList = function (e) {
                ...
                _parseVideoDuration: function (e) {
                    e = +e;
                    var t = Math.floor(e / 3600), s = Math.floor((e - 60 * t * 60) / 60), e = e - 60 * t * 60 - 60 * s, a = "" + (t ? (10 > t ? "0" + t : t) + " : " : "") + (10 > s ? "0" + s : s) + " : " + (10 > e ? "0" + e : e);
                    return a
                },
                load: function (e) {
                    var t = this;
                    R.get(this.uri, {thread_id: e, url: h.href}, function (e) {
